...
public class App extends Application {
    ...
    public static void loadTournement(String Name)throws IOException{
            ...
            String str;
                ...
                while ((str=br.readLine())!=null){
                    ...
                    Round r = new Round();
                    while (!str.equals("++++")){//round seperator
                        System.out.println("1");
                        
                        while (!(str.equals("----"))){//game seperator
                        String strA = str;//player1 name
                        System.out.println(strA);
                        String strB = br.readLine();//player2 name
                        System.out.println(strB);
                        String score = br.readLine();
                        Person a = null;
                        Person b = null;
                        for (int i = 0; i<curr.people.size();i++){
                            if ((curr.people.get(i).name).equals(strA)){
                                a = curr.people.get(i);
                            }
                            else if ((curr.people.get(i).name).equals(strB)){
                                b = curr.people.get(i);
                            } 
                            if (a!=null&&b!=null){
                                break;
    ...
    public static void save()throws IOException{
        ...
        File newT = new File("./"+name+".txt");
        newT.createNewFile();
        FileWriter fWriter = new FileWriter("./"+name+".txt");
        FileWriter tWriter = new FileWriter("./AllTournements.txt");
